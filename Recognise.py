...
face_cas = cv2.CascadeClassifier(
    "C://Users/jagriti sharma/Desktop/attendance/haarcascade_frontalface_default.xml")
cap = cv2.VideoCapture(0)
recognizer = cv2.face.LBPHFaceRecognizer_create()
recognizer.read("C://Users/jagriti sharma/Desktop/attendance/train/trainer.yml")
flag = 0
id = 0
filename = 'filename'
dict = {
